        ...
        <div className="flex h-16 justify-between items-center">
          ...
          <div className="flex items-center gap-5">
            {user ? (
              <>
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 rounded-full border border-gray-300 shadow-inner cursor-pointer"
                  >
                    <img
                    ...
                    <>
                      ...
                      <div className="absolute right-0 mt-2.5 w-48 bg-white border border-gray-200 rounded-xl shadow-md py-1.5 z-20 text-xs font-medium text-gray-700 animate-fade-in">
                        ...
                        <button
                          ...
                          className="w-full text-left block px-3.5 py-2 text-red-500 hover:bg-red-50 transition-colors border-t border-gray-100 cursor-pointer"
                        >
                          Sign Out
                        </button>
                      </div>
              ...
              <Link
                to={PATHS.LOGIN}
                className="bg-gray-900 hover:bg-blue-600 text-white text-xs font-bold uppercase tracking-wider px-4 py-2 rounded-xl transition-all shadow-2xs hover:shadow-xs flex items-center gap-1.5"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
